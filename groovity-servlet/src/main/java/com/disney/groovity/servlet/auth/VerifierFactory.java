...
public class VerifierFactory {
	...
	public Verifier createVerifier(List auths, Class<Script> scriptClass) throws ReflectiveOperationException, MalformedURLException, URISyntaxException, NoSuchAlgorithmException, InvalidKeySpecException, CertificateException{
	...
	private void processCommon(AbstractVerifier verifier, Map map, Class scriptClass) throws ReflectiveOperationException{
	...
	private void addKeychain(Object keychain, List<KeyChain> keychains, Class<Script> scriptClass) throws ReflectiveOperationException {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	private SignatureVerifierImpl processSignature(Map signature, Class<Script> scriptClass) throws ReflectiveOperationException, MalformedURLException, URISyntaxException, NoSuchAlgorithmException, InvalidKeySpecException, CertificateException{
	...
	private PolicyVerifierImpl processPolicy(@SuppressWarnings("rawtypes") final Map policy, Class<Script> scriptClass) throws MalformedURLException, URISyntaxException, ReflectiveOperationException{
	...
	private void addPasswordChecker(Object passwordChecker, List<PasswordChecker> passwordCheckers, Class<Script> scriptClass) throws ReflectiveOperationException{
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private BasicVerifierImpl processBasic(Map basic, Class scriptClass) throws ReflectiveOperationException{
	...
	private Object fallbackConstruct(Object className, Class<Script> scriptClass) throws ReflectiveOperationException {
		try{
	...
	@SuppressWarnings("rawtypes")
	private void addDigester(Object passwordDigester, List<PasswordDigester> passwordDigesters, Class<Script> scriptClass) throws ReflectiveOperationException{
	...
	@SuppressWarnings("rawtypes")
	private void addAccessController(Object accessController, List<AccessController> accessControllers, Class<Script> scriptClass) throws ReflectiveOperationException{
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private DigestVerifierImpl processDigest(Map digest, Class<Script> scriptClass) throws ReflectiveOperationException{
